...
│   ├── console.html         # 主控制台网页
│   ├── control-center.html  # 统一首页
│   ├── send.html            # 统一发送台(Flow 1 + Flow 2-10)
...
- **Sales Brain / 自动回复** → 默认关闭。Tracker 仍会记录回复，但不会自动回复客户；以后准备好后可在 Settings 开启并重启 Mamba。
...
| 服务 | 地址 |
|------|------|
| Mamba Control Center | http://127.0.0.1:8787/control-center |
| 发送台 | http://127.0.0.1:8787/send |
