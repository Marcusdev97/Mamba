...
const KNOWN = {
  ...
  "Bot Rules.command":                 { emoji: "🧠", label: "Bot Rules 大脑", desc: "编辑分类关键词,并从页面进入 Learning Queue 批量批准真实成功对话", group: "设置 & 工具", order: 24 },
  "脑编辑器.command":                   { emoji: "📝", label: "Project Brain", desc: "可视化查看市场项目、QA 状态与 Active Brain,也可进入 Project Editor 维护盘资料", group: "设置 & 工具", order: 23 },
  "安装每晚成绩单.command":             { emoji: "📊", label: "安装每晚成绩单(一次永久)", desc: "双击一次,以后每晚 10 点自动把今天 blast/回复/温度/call 数发去 Mamba 系统台", group: "设置 & 工具", order: 27 },
