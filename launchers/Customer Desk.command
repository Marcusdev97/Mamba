...
# One daily customer workspace:
#   Inbox                    -> reply scan, classification and history
#   Follow-Up & Appointments -> agent actions and appointment pipeline
